defmodule UnstuckWeb.Router do
  use UnstuckWeb, :router
  use Kaffy.Routes #, scope: "/admin", pipe_through: [:some_plug, :authenticate]

  import UnstuckWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {UnstuckWeb.LayoutView, :root}
...
#    get "/mytasks", TaskController, :my_tasks
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: UnstuckWeb.Telemetry
    end
  end
